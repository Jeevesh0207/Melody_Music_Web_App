...
function TopHits() {
    ...
    const [TopHitsData, setTopHitsData] = useState([])
    ...
    const SetSongDetail = async (item) => {
        ...
        localStorage.setItem("CurrentSongArray", JSON.stringify(TopHitsData))
                        ...
                        return (
                            <div className='Box' key={item.id}>
                                <div className='Poster'>
                                    ...
                                    {/* <img src={API + '/tophitsimages/' + item.id + '.jpg'} alt='png'></img> */}
                                    <LazyLoadImage
                                        width='100%'
                                        height='100%'
                                        // src={API + '/tophitsimages/' + item.id + '.jpg'}
                                        src={
